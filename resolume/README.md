...
- source commits: `e43422d`, `7daa9fb`, `206b844`;
...
The test suite validates the adapter contract only. A live Resolume host
connection remains an explicit integration step for a future host adapter.
